    ...
    <div className="bg-[#0a0f1c] min-h-screen text-white py-30 px-6 md:px-20">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        <div className=" border-1 p-6 rounded-xl shadow-lg flex flex-col items-center">
          ...
          <a href="/CV/Cv_AhmedSamy.pdf" download className="mt-6 bg-gray-800 hover:bg-gray-700 px-6 py-2 rounded-lg transition flex items-center gap-2 text-white w-fit">
